...
const COACHES_DEF = [
  ['Karim', 'Benali', 16, ['fitness', 'boxe'], 35, '0611223344', false, "Coach fitness et boxe depuis 5 ans, spécialisé remise en forme et perte de poids."],
  ['Selim', 'Ouadi', 17, ['fitness', 'musculation', 'boxe'], 30, '0618336933', true, "Coach diplômé BPJEPS, 6 ans en salle. Spécialisé renforcement et boxe, à l'aise avec les débutants comme les confirmés."],
  ['Amandine', 'Roussel', 18, ['aqua', 'fitness'], 28, '0622334455', false, "Monitrice aquagym depuis 8 ans, cours collectifs et coaching individuel en bassin."],
  ['Thomas', 'Girard', 8, ['crosstraining', 'musculation'], 45, '0633445566', false, "Ancien pratiquant de CrossFit compétition, aujourd'hui coach à temps plein. J'interviens en salle ou en cours collectifs, préparation physique générale, remise en forme post-blessure, et suivi personnalisé sur plusieurs mois. Diplômé STAPS entraînement sportif."],
  ...
  ['Yanis', 'Belkacem', 20, ['boxe', 'cardio'], 32, '', true, "Coach boxe éducative et cardio-boxe, ancien compétiteur amateur."],
  ['Chloé', 'Marchand', 21, ['musculation', 'fitness'], 38, '0655667788', false, "Préparation physique et musculation, suivi nutritionnel de base inclus."],
  ['Maxime', 'Perrin', 9, ['crosstraining', 'cardio'], null, '0666778899', false, ""],
  ['Sofia', 'Nasri', 27, ['poledance', 'fitness'], 42, '0677889900', false, "Pole dance loisir et sportif, tous niveaux. Cours particuliers ou en petit groupe (2-4 personnes), matériel fourni. J'accompagne aussi la préparation physique spécifique (gainage, souplesse) pour progresser plus vite sur les figures."],
  ['Antoine', 'Lefebvre', 24, ['musculation'], 33, '0688990011', false, "Coach musculation, hypertrophie et force. Programmes sur mesure."],
  ['Emma', 'Dubreuil', 3, ['yoga', 'cardio'], 55, '0699001122', true, "Coach parisienne, yoga dynamique et cardio training en extérieur ou en salle."],
  ['Rayan', 'Cherif', 29, ['boxe', 'crosstraining'], 36, '0611002233', false, "Boxe anglaise et cross-training, préparation physique pour sports de combat."],
  ['Léa', 'Moreau', 26, ['fitness', 'pilates'], 34, '0622113344', false, "Cours collectifs fitness et pilates, spécialisée reprise de sport après grossesse."],
  ['Hugo', 'Bonnet', 22, ['musculation', 'cardio', 'crosstraining'], 39, '0633224455', false, "10 ans d'expérience, du débutant au pratiquant confirmé. Je me déplace aussi en salle partenaire si besoin."],
  ['Nora', 'Haddad', 25, ['aqua'], 27, '', false, "Aquagym et aquabike, cours collectifs dynamiques en musique."],
  ['Camille', 'Fontaine', 5, ['pilates', 'yoga'], 48, '0611335577', false, "Pilates sur tapis et yoga restauratif, cabinet privé dans le 15e."],
  ['Nicolas', 'Lambert', 6, ['musculation', 'fitness'], 37, '0622446688', false, "Coach à domicile ou en salle partenaire, secteur Montmartre. Programmes hypertrophie et remise en forme générale, suivi hebdomadaire avec ajustement des charges et bilan mensuel."],
  ['Sarah', 'Morel', 30, ['crosstraining', 'boxe'], 41, '0633557799', true, "Ex-athlète de haut niveau reconvertie coach. Cross-training intensif et boxe pieds-poings."],
  ['Alexandre', 'Aziz', 31, ['musculation', 'cardio'], 30, '0644668800', false, "Salle partenaire à Boulogne, cours particuliers en soirée."],
  ['Inès', 'Legrand', 32, ['aqua', 'fitness'], 29, '0655779911', false, "Cours d'aquagym en piscine municipale, groupes de 6 personnes maximum."],
  ['Mathieu', 'Faure', 33, ['boxe', 'musculation'], 34, '0666880022', false, "Boxe française et anglaise, préparation physique associée."],
  ['Océane', 'Chevalier', 34, ['yoga', 'pilates', 'cardio'], 44, '0677991133', false, "Studio privé à Antony. Yoga vinyasa, pilates renforcement, cardio doux pour tous niveaux. Cours individuels ou en duo, matériel fourni, possibilité de forfaits mensuels dégressifs."],
  ['Bilal', 'Robin', 35, ['crosstraining', 'musculation'], 40, '0688002244', false, "Coach cross-training, ancien militaire, discipline et rigueur."],
  ['Marion', 'Gauthier', 36, ['fitness', 'boxe'], 31, '', false, "Cours collectifs fitness-boxe le samedi matin, secteur Saint-Denis."],
  ['Kevin', 'Boucher', 37, ['musculation', 'crosstraining'], 36, '0699113355', false, "Préparateur physique, clientèle sportifs amateurs et coureurs."],
  ['Zoé', 'Meunier', 38, ['aqua', 'yoga'], 33, '0611445588', true, "Double compétence aqua et yoga, cours en extérieur l'été."],
  ['Adrien', 'Dumas', 39, ['boxe', 'crosstraining', 'cardio'], 38, '0622556699', false, "Ancien coach en club de boxe, aujourd'hui indépendant sur Bobigny et alentours. Cours particuliers, petits groupes, préparation à la compétition amateur possible sur demande."],
  ['Jade', 'Barbier', 40, ['fitness', 'pilates'], 35, '0633667700', false, "Cours à domicile ou en extérieur, spécialiste renforcement postural."],
  ['Enzo', 'Colin', 41, ['musculation'], 32, '0644778811', false, "Musculation pure, tous objectifs (prise de masse, sèche, force)."],
  ['Clara', 'Henry', 42, ['yoga', 'cardio'], 42, '0655889922', false, "Professeure de yoga et coach cardio, cours en petit comité à Vitry."],
  ['Nathan', 'Vidal', 43, ['crosstraining', 'boxe'], 39, '0666990033', false, "Coach cross-training et boxe, préparation physique générale. Interventions en salle partenaire ou en extérieur selon la météo, créneaux tôt le matin privilégiés pour les actifs."],
  ['Louna', 'Fournier', 44, ['fitness', 'aqua'], 30, '0677001144', false, "Cours collectifs fitness et aquagym, secteur Saint-Maur."],
  ['Théo', 'Rousseau', 45, ['musculation', 'cardio'], 34, '', false, "Coach musculation et cardio-training, salle partenaire à Cergy."],
  ['Salomé', 'Mercier', 46, ['pilates', 'yoga'], 46, '0688112255', true, "Pilates et yoga prénatal/postnatal, spécialisation reconnue."],
  ['Mehdi', 'Blanchard', 47, ['boxe', 'musculation'], 33, '0699223366', false, "Boxe anglaise, cours particuliers et petits groupes à Sarcelles."],
  ['Juliette', 'Guerin', 0, ['fitness', 'pilates'], 50, '0611556677', false, "Coach dans le 1er arrondissement, clientèle entreprise et particuliers. Cours en studio privé, matériel haut de gamme, créneaux early morning et pause déjeuner disponibles toute la semaine."],
  ['Baptiste', 'Muller', 1, ['musculation', 'crosstraining'], 47, '0622667788', false, "Coach diplômé, secteur Panthéon, préparation physique générale et spécifique."],
  ['Yasmine', 'Leroy', 2, ['yoga', 'cardio'], 52, '0633778899', false, "Yoga dynamique près de l'Opéra, cours du matin avant le travail."],
  ['Romain', 'Garnier', 4, ['boxe', 'crosstraining'], 43, '', false, "Boxe et cross-training dans le 13e, ambiance conviviale."],
  ['Elsa', 'Chevallier', 7, ['fitness', 'aqua'], 36, '0644889900', true, "Cours fitness et aquagym secteur Ménilmontant, groupes réduits."],
  ['Quentin', 'Duval', 10, ['musculation'], 31, '0655990011', false, "Coach musculation à Meaux, suivi rigoureux, programmes évolutifs."],
  ['Lina', 'Andre', 11, ['pilates', 'yoga'], 39, '0666001122', false, "Studio pilates à Chelles, cours en petit groupe ou individuel."],
  ['Gabriel', 'Caron', 12, ['crosstraining', 'boxe'], 37, '0677112233', false, "Coach polyvalent à Provins, cross-training et boxe éducative pour tous niveaux, du débutant complet au pratiquant qui prépare une première compétition amateur."],
  ['Anaïs', 'Aubert', 13, ['yoga', 'fitness'], 41, '0688223344', false, "Yoga et fitness doux, secteur Versailles, clientèle variée."],
  ['Simon', 'Renaud', 14, ['musculation', 'cardio'], 35, '0699334455', false, "Salle partenaire à Saint-Germain-en-Laye, coaching individuel."],
  ['Amélie', 'Roy', 15, ['aqua', 'pilates'], 32, '', false, "Aquagym et pilates à Mantes-la-Jolie, cours collectifs le soir."],
  ['Loïc', 'Noel', 19, ['boxe', 'musculation'], 30, '0611667788', false, "Boxe anglaise et musculation à Rambouillet, cours particuliers."],
  ['Margaux', 'Riviere', 28, ['fitness', 'crosstraining'], 40, '0622778899', true, "Coach fitness et cross-training à Sainte-Geneviève-des-Bois. Ancienne sportive de haut niveau en athlétisme, reconvertie dans le coaching il y a 4 ans, spécialisée préparation physique générale."],
  ['Younes', 'Pierre', 48, ['musculation', 'boxe'], 34, '0633889900', false, "Coach musculation et boxe à Argenteuil, suivi personnalisé."],
...
const GYMS_DEF = [
  ...
  ['Muscu Club Savigny', 21, ['musculation', 'cardio'], 'David Simon', '0160000007',
    "Salle de muscu classique, cherche coach pour suivi personnalisé des adhérents premium."],
  ['Pole & Fit Fontainebleau', 9, ['poledance', 'fitness'], 'Camille Aubert', '0160000008',
    "Studio pole dance et fitness, ambiance conviviale, tous niveaux."],
  ['Iron Gym Juvisy', 25, ['musculation', 'boxe'], 'Kevin Lopez', '0160000009',
    "Salle de sport 24/7, cherche coachs indépendants pour cours collectifs early morning."],
  ['Wellness Center Paris 12', 3, ['yoga', 'cardio', 'pilates'], 'Aurélie Blanc', '0160000010',
  ...
  ['Vita Sport Versailles', 13, ['fitness', 'musculation'], 'Delphine Cohen', '0170000001',
  ...
  ['Montreuil CrossBox', 37, ['crosstraining', 'boxe'], 'Elise Fabien', '0170000009',
    "Box hybride cross-training/boxe, communauté active sur les réseaux."],
  ['Aubervilliers Muscu', 38, ['musculation'], 'Karim Zeroual', '0170000010',
    "Salle de musculation traditionnelle, clientèle fidèle, cherche coach pour cours du soir."],
  ['Bobigny Fitness', 39, ['fitness', 'cardio'], '', '',
    ""],
  ['Aulnay Sport Plus', 40, ['musculation', 'crosstraining'], 'Nadia Cherfi', '0170000012',
    "Grande salle multi-espaces, forte demande de coaching individuel non satisfaite en interne."],
  ['Créteil Aqua Gym', 41, ['aqua'], 'Bruno Lacroix', '0170000013',

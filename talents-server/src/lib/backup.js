...
// à Railway (Cloudflare R2 — compatible S3) — copié tel quel de
// admin-server/src/lib/backup.js (même pattern déjà utilisé par server/ et
// admin-server/), seul BACKUP_PREFIX change. Silencieuse si non configurée.
...
// AES-256-GCM : cette base contient des comptes coach/salle (email, coordonnées
// de contact) — le chiffrement du bucket seul ne suffit pas, la clé ne doit
// exister que dans les variables d'env Railway, jamais dans le bucket.
...
const BACKUP_PREFIX = 'talents-server';
